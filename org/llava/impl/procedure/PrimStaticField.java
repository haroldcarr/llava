 ...
 * Last Modified : 2005 May 20 (Fri) 13:37:33 by Harold Carr.
 */
	...
	PrimitiveProcedure
{
	...
	try {
		...
		return RI.staticFieldSet(fieldName, targetClass, value);
	    }
	    Object result = RI.staticFieldRef(fieldName, targetClass);
